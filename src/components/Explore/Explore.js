...
function Explore() {
  ...
  const destinations = [
    ...
    },
    {
      ...
      description: "A network of lagoons and lakes offering serene houseboat experiences.",
    ...
    },
    {
      id: 6,
      title: "Hampi",
      description: "A UNESCO World Heritage Site known for its ancient temples.",
    ...
    // Second page destinations (all from India)
    {
      id: 9,
      title: "Leh-Ladakh",
      description: "Known for its breathtaking landscapes and adventure activities.",
    ...
    },
    {
      id: 11,
      title: "Darjeeling",
      description: "Famous for its tea gardens and scenic views of the Himalayas.",
    ...
    },
    {
      id: 12,
      title: "Rishikesh",
      description: "Known as the Yoga Capital of the World, located on the banks of the Ganges.",
    ...
    },
    {
      id: 13,
      title: "Udaipur",
      description: "The City of Lakes, known for its stunning palaces and hospitality.",
    ...
    },
    {
      ...
      description: "A UNESCO World Heritage Site, famous for its architectural excellence.",
    ...
    },
    {
      id: 16,
      title: "Nainital",
      description: "A picturesque hill station known for its lake and scenic views.",
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20">
            ...
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">
              ...
              At TravelXplore, we bring you closer to the captivating destinations of India. Discover the diverse cultures, rich history, and breathtaking landscapes that make this country a traveler's paradise. From majestic palaces to serene backwaters, let us guide you on your next unforgettable journey through India.
            </p>
          </div>
          ...
          <div className="flex justify-center mt-10">
            <button
              ...
              className={`mx-1 px-3 py-1 border rounded ${currentPage === 1 ? "bg-gray-300" : "bg-gray-100"}`}
            >
              &lt;
            </button>
              ...
              number === "..." ? (
                ...
                <button
                  ...
                  className={`mx-1 px-3 py-1 border rounded ${
                    currentPage === number ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-600"
                  }`}
                >
                  {number}
                </button>
            ...
            <button
              ...
              className={`mx-1 px-3 py-1 border rounded ${currentPage === totalPages ? "bg-gray-300" : "bg-gray-100"}`}
            >
              &gt;
            </button>
          </div>
